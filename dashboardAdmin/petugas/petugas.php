    ...
    <div class="flex-1 flex flex-col h-screen w-full relative">
        ...
        <div class="px-6 py-4 bg-white border-b border-popfit-border flex items-center justify-between">
            <div class="flex-1 max-w-md bg-popfit-bg border border-popfit-border rounded-sm px-4 py-2 flex items-center">
                ...
                <input type="text" id="searchInput" placeholder="Cari Nama atau Username..." class="flex-1 bg-transparent border-none outline-none text-[11px] font-bold text-popfit-dark uppercase">
            </div>
            <a href="tambahPetugas.php" class="bg-popfit-dark text-white px-4 py-2.5 text-[10px] font-black uppercase tracking-[0.1em] rounded-sm hover:bg-popfit-light transition-all flex items-center ml-4">
                <i class="ph-bold ph-plus-circle mr-2"></i> Tambah Petugas
            </a>
        </div>
