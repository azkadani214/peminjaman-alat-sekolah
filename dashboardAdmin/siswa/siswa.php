    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-popfit-dark text-white border-r border-popfit-dark h-full flex-shrink-0 z-50 sidebar -translate-x-full md:translate-x-0 md:static flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1">
                ...
                <li><a href="siswa.php" class="nav-active flex items-center px-6 py-3 text-gray-200 hover:bg-popfit-light transition-colors border-l-4 border-transparent">
    ...
    <div class="flex-1 flex flex-col h-screen w-full relative">
        <header class="h-16 bg-popfit-surface border-b border-popfit-border flex items-center justify-between px-6 flex-shrink-0">
            <div class="flex items-center">
                ...
                <h2 class="text-lg font-black text-popfit-dark uppercase tracking-tight">Manajemen Siswa</h2>
            </div>
            <a href="tambahSiswa.php" class="bg-popfit-dark text-white px-4 py-2 text-[10px] font-black uppercase tracking-[0.1em] rounded-sm hover:bg-popfit-light transition-all flex items-center">
                <i class="ph ph-user-plus-bold mr-2"></i> Tambah Siswa
            </a>
        </header>
