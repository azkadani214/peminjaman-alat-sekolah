...
if(isset($_POST['simpan'])){
    $id_alat = mysqli_real_escape_string($connect, $_POST['id_alat']);
    ...
    if($_FILES['foto']['error'] === 0){
        ...
        $newName = uniqid() . "." . $ext;
        move_uploaded_file($tmpName, '../../asset/' . $newName);
        $foto = $newName;
    }

    $query = "INSERT INTO alat_olahraga (id_alat_olahraga, nama_alat_olahraga, kategori, deskripsi, stok, foto_alat_olahraga)
    ...
    if(mysqli_query($connect, $query)){
        ...
        $error = "Gagal menambahkan alat: " . mysqli_error($connect);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Alat - PopFit Admin</title>
